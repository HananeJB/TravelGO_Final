            ...
            <div class="card-body p-0">
                <div class="row">
                    <div class="col-lg-5 col-xl-6 d-none d-lg-flex">
                        <div class="flex-grow-1 bg-register-image" style="background: url(&quot;/admin/assets/img/dogs/bg_3.jpg&quot;);background-size: cover;"></div>
                    </div>
                    <div class="col-lg-7 col-xl-6">
                        <div class="p-5" style="border-radius: 25px;">
                            ...
                            <form class="user" method="POST" action="{{ route('register') }}">
                                ...
                                </div><button class="btn btn-primary btn-block text-white btn-user" type="submit" style="background: #f85959;border-color: rgb(255, 255, 255);border-top-color: rgb(255,;border-right-color: 255,;border-bottom-color: 255);border-left-color: 255,;"> {{ __('Register') }}</button>
                                <hr>
                                <hr>
                            </form>
